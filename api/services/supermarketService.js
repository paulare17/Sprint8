...
exports.supermarketService = void 0;
...
class SupermarketService {
    ...
    async addManualSupermarket(data) {
        const supermarketData = {
            ...data,
            source: 'manual'
        };
        const newSupermarket = new Supermarket_1.Supermarket(supermarketData);
        const saved = await newSupermarket.save();
        return saved;
    }
    ...
    async getSupermarketStats() {
        const stats = await Supermarket_1.Supermarket.aggregate([
            {
                $group: {
                    _id: null,
